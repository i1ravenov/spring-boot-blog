...
-- ---- seed posts ----
MERGE INTO post (id, title, text, likes_count, comments_count) KEY(id) VALUES
(1,
...
(1, 1), (1, 2), (1, 3),          -- java, spring, spring-boot
(2, 1), (2, 2), (2, 4), (2, 5),  -- java, spring, jdbc, jpa
(3, 1), (3, 2), (3, 6), (3, 7),  -- java, spring, rest, api
(4, 1), (4, 3), (4, 8), (4, 9),  -- java, spring-boot, testing, junit
(5, 1), (5, 10), (5, 11);         -- java, docker, devops
...
ALTER TABLE tag     ALTER COLUMN id RESTART WITH 12;
